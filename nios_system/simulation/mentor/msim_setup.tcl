...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                             
  vlog     "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                           
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                               
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                 
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_003.sv"                        -work router_003                                  
  ...
  vlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu.v"                                     -work cpu                                         
  vlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_sysclk.v"                  -work cpu                                         
  vlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_tck.v"                     -work cpu                                         
  vlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_wrapper.v"                 -work cpu                                         
  vlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_test_bench.v"                          -work cpu                                         
