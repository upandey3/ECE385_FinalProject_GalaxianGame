...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                             
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                           
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                 
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_003.sv"                        -work router_003                                  
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu.v"                                     -work cpu                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_sysclk.v"                  -work cpu                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_tck.v"                     -work cpu                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_wrapper.v"                 -work cpu                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_test_bench.v"                          -work cpu                                         
