...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                              -cdslib ./cds_libs/error_adapter_0.cds.lib                             
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                            -cdslib ./cds_libs/avalon_st_adapter.cds.lib                           
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                                -cdslib ./cds_libs/rsp_demux_001.cds.lib                               
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                  -cdslib ./cds_libs/cmd_mux_001.cds.lib                                 
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_003.sv"                        -work router_003                                   -cdslib ./cds_libs/router_003.cds.lib                                  
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu.v"                                     -work cpu                                          -cdslib ./cds_libs/cpu.cds.lib                                         
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_sysclk.v"                  -work cpu                                          -cdslib ./cds_libs/cpu.cds.lib                                         
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_tck.v"                     -work cpu                                          -cdslib ./cds_libs/cpu.cds.lib                                         
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_debug_slave_wrapper.v"                 -work cpu                                          -cdslib ./cds_libs/cpu.cds.lib                                         
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_cpu_test_bench.v"                          -work cpu                                          -cdslib ./cds_libs/cpu.cds.lib                                         
